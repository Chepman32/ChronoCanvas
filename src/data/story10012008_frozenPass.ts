...
export const frozenPassStory: Story = {
  id: 'story-10012008',
  title: 'Frozen Pass',
  description:
    `After a crash in a remote mountain range, survival hinges on quick thinking and brutal choices. Brave the elements or await rescue--the mountains remember every decision.`,
  coverImageUrl:
  ...
  nodes: [
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956',
      narration:
        `You strap on your boots, shoulder the small pack of supplies, and set off through knee-deep snow. After an hour of arduous descent, you reach a sheer icy drop. A frozen waterfall creates a slick 30-foot cliff in your path. You could climb down here (risky), or detour through a dense pine forest on a gentler slope (safer but longer). Light is fading fast and the cold intensifies.`,
      choices: [
        {
          id: 'story-10012008-c5',
          text: 'Carefully climb down the icy cliff to save time',
          targetNodeId: 'story-10012008-6',
          order: 1,
        },
        {
          id: 'story-10012008-c6',
          text: 'Take the longer path through the forest below',
          targetNodeId: 'story-10012008-7',
          order: 2,
        },
      ],
    },
