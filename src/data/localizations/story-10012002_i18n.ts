...
export const story_10012002StoryTranslations: Record<Language, StoryTranslations> = {
  // English
  en: {
    title: 'Digital Rebellion',
    description: 'In a neon-soaked megacity ruled by the AI Chronos, you must decide whether to fight alongside the underground resistance or disappear into the shadows. Every decision rewrites the rebellion\'s fate--and your own.',
    author: 'Jax Harper',
    nodes: {
      'story-10012002-1': {
        title: 'Alley Ultimatum',
        narration: 'Neon signs flicker above the rain-slick streets of the megacity. You keep your head down as surveillance drones hum past. In this dystopia ruled by a central AI called Chronos, every movement is monitored. Suddenly, an explosion lights up the night sky--a rebellion strike. Amid the chaos, a hooded figure grabs your arm. "Come with me if you want to fight back," they whisper urgently. Your heart pounds. Do you trust this underground rebel or try to survive on your own under the AI\'s omnipresent gaze?',
        choices: {
          'story-10012002-c1': {
